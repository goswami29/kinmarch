                ...
                <div class="col-lg-7">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="widgets-container">
                            <h5>Add / Edit Brand</h5>
                            <hr>
                            <form method="Post"  action="<?php echo site_url('admin/Brand/addbrand') ?>" enctype="multipart/form-data">
                                <input type="hidden" name="id" value="<?php echo $id ?>">

                                <div class="form-group">
                                    <label for="exampleInputEmail1">English Brand Title</label>
                                    <input class="form-control m-t-xxs" name="eng_title" required="" type="text" value="<?php echo $eng_title ?>">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">French Brand Title</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <?php if (isset($edit['image']) && !empty($edit['image'])) { ?>
                                        <img class="stream-img" style="height:100px; margin-right: 10px;
                                             margin-bottom: 10px;"   src="<?php echo base_url(); ?>upload/brand/<?php echo $userfile ?>"/>
                                         <?php } ?>
                                    <div class="col-sm-12">
