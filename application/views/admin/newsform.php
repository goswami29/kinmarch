...
if (isset($edit) && !empty($edit)) {
    $id = $edit['id'];
    $eng_userfile = $edit['eng_image'];
    $fr_userfile = $edit['fr_image'];
    ...
    $id = set_value('id');
    $eng_userfile = set_value('eng_image');
    $fr_userfile = set_value('fr_image');
                ...
                <div class="col-lg-7">
                    <div class="ibox float-e-margins">
                        <div class="widgets-container">
                            <h3>Add / Edit News & Event</h3>
                            <hr>
                            <form method="Post"  action="<?php echo site_url('admin/News/addnews') ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label">English Image</label>
                                    <?php if (isset($edit['eng_image']) && !empty($edit['eng_image'])) { ?>
                                        <img class="stream-img" style="height:100px; margin-right: 10px;
                                             margin-bottom: 10px;"   src="<?php echo base_url(); ?>upload/news/<?php echo $eng_userfile ?>"/>
                                         <?php } ?>
                                    <div class="col-sm-10">
                                        <label class="custom-file">
                                            <input type="file" id="file" name="eng_userfile"  class="custom-file-input">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 control-label">French Image</label>
                                    <?php if (isset($edit['fr_image']) && !empty($edit['fr_image'])) { ?>
                                        <img class="stream-img" style="height:100px; margin-right: 10px;
                                             margin-bottom: 10px;"   src="<?php echo base_url(); ?>upload/news/<?php echo $fr_userfile ?>"/>
                                         <?php } ?>
                                    <div class="col-sm-10">
                                        <label class="custom-file">
                                            <input type="file" id="file" name="fr_userfile"  class="custom-file-input">
                                            <span class="custom-file-control"></span>
                                        </label>
                                    </div>
                                </div>
