                ...
                <div class="ibox float-e-margins">
                    ...
                    <div id="demo7" class="ibox-content collapse show">
                        <div class="borderedTable">
                            ...
                            <?php } ?>
                            <h2> News & Event List
                                <a href="<?php echo site_url('admin/news/addnews') ?>"  class="btn  btn-round btn-primary pull-right blue">Add News & Event</a> 
                            </h2>
                                        ...
                                        if (isset($list) && !empty($list)) {
                                            ...
                                            foreach ($list as $val) {
                                                ...
                                                <tr id="banners-<?php echo $val['id']; ?>">
                                                    ...
                                                    <td>
                                                        <a href = '<?php echo site_url('admin/news/edit/' . $val['id']); ?>' class='btn btn-outline btn-round green btn-sm blue'> <i class='fa fa-edit'></i> Edit</a>
                                                        <a href='javascript:void(0)' url = '<?php echo site_url('admin/news/delete/' . $val['id']); ?>' class='btn btn-outline btn-round dark btn-sm black delete'> <i class='fa fa-trash-o'></i> Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
...
<script type="text/javascript">
    ...
    function save_sortable() {
        ...
        console.log(serial);
        $.ajax({
            url: '<?php echo site_url('admin/news/organize'); ?>',
            type: 'POST',
            data: serial
        });
    }
