                                        ...
                                        if (isset($list) && !empty($list)) {
                                            ...
                                            foreach ($list as $val) {
                                                ...
                                                <tr id="banners-<?php echo $val['id']; ?>">
                                                    ...
                                                    <td>
                                                        <a href = '<?php echo site_url('admin/Welcome/edit/' . $val['id']); ?>' class='btn btn-outline btn-round green btn-sm blue'> <i class='fa fa-edit'></i> Edit</a>
                                                    </td>
                                                </tr>
                                                <?php
                                                $i++;
